...
논리 블록은 일반적으로 [조건 블록](https://github.com/RobomationLAB/User_Guide/wiki/조건문)과 [반복 블록](https://github.com/RobomationLAB/User_Guide/wiki/반복)을 제어하는 데 사용됩니다.  
...
## 문자열 찾기
이 블록들은 특정 문자열가 다른 문자열 안에 있는지 확인하고, 존재하는 경우 위치를 반환합니다.  
...
이것은 [문자열의 “빈 문자열 확인” 블록](https://github.com/RobomationLAB/User_Guide/wiki/문자열#빈-문자열-확인)과 유사합니다.
...
이것은 [문자열의 “문자열 길이” 블록](https://github.com/RobomationLAB/User_Guide/wiki/문자열#문자열-길이)과 유사합니다.
...
이 블록들은 [문자열의 “문자열 찾기” 블록](https://github.com/RobomationLAB/User_Guide/wiki/문자열#문자열-찾기)과 유사합니다.
...
## 리스트 출력하기  
[텍스트의 “출력” 블록](https://github.com/RobomationLAB/User_Guide/wiki/문자열#문자열-출력)은 리스트를 출력할 수 있습니다.  
...
## 리스트의 각 항목에 대해
[반복의 “각 항목에 대해” 블록](https://github.com/RobomationLAB/User_Guide/wiki/반복#각-항목에-대해)은 리스트의 각 항목에 대해 연산을 수행합니다.  
...
[반복 종료 블록](https://github.com/RobomationLAB/User_Guide/wiki/반복#반복문-종료-블록)들의 예시도 참고하세요.
...
<img src="https://github.com/user-attachments/assets/cece7ab2-fe34-4b92-bef8-53da4bfb6727" width="30%" />
