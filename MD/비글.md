...
![](https://github.com/user-attachments/assets/8fc794c3-2897-4c9d-adcd-d87fd3931864)
...
![](https://github.com/user-attachments/assets/be6f61e3-715a-4854-9dbd-8f459336cd09)
...
| 이름 | 구분 | 설명 | 범위 / 종류 |  
| ------ | ------ | ------ | ------ |
| axis | 드롭다운 옵션 | 축 기준 | x축(x), y축(y), z축(z)|
### 자바스크립트 코드
```javascript
// x축 자이로 센서
...
![](https://github.com/user-attachments/assets/7b91f4f6-980c-498c-9864-6fd8b563be91)
