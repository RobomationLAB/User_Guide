...
| --- | --- |
| 파이썬 | <pre><code>if __('{Device}:wheel.move').d != 0: &#10;   __('{Device}:wheel.move').d = 0</code></pre> |
| 자바스크립트 | <pre><code>if($('{Device}:wheel.move').d != 0) { &#10;   $('{Device}:wheel.move').d = 0; &#10;}</pre></code> |
...
[순기구학(Forward Kinematics)](https://github.com/RobomationLAB/Raccoon_API_KR/wiki/4DoF-Kinematics#forward-kinematics-순기구학) 알고리즘을 사용하여 각 관절의 각도를 xyz 좌표로 변환합니다.
...
[역기구학(Inverse Kinematics)](https://github.com/RobomationLAB/Raccoon_API_KR/wiki/4DoF-Kinematics#inverse-kinematics-역기구학) 알고리즘을 사용하여 xyz 좌표를 네 관절의 각도로 변환합니다.
