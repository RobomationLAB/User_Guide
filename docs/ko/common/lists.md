...
## 리스트에서 항목 잘라내기 {#lists_getIndex}

**리스트에서 ... 잘라내기** 블록은 항목을 가져오는 것뿐만 아니라 원본 리스트에서 해당 항목을 제거합니다.
...
## 리스트에서 원하는 위치에 삽입 {#lists_setIndex}
...
## 리스트 ... 항목을 ... (으)로 바꾼 리스트 추출 {#lists_replace}
