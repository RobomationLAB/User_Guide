...
※ 파이썬 미리보기는 **블록코딩 에디터**에서만 제공됩니다.  
파이썬 에디터에서는 사용자가 직접 코드를 작성하기 때문에 미리보기가 제공되지 않습니다.
...
- **카메라 해상도** 를 변경할 수 있습니다.

<br>

## 콘솔 {#console}

콘솔 탭에서는 프로그램 실행 중에 출력되는 로그(Log) 메시지와 스코프(Scope) 그래프를 실시간으로 확인할 수 있습니다.  
