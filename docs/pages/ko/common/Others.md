...
**한 줄 주석** 블록을 사용하면 코드의 실행에는 영향을 주지 않으면서 **설명** 을 추가할 수 있습니다.  
...
## 여러 줄 주석 {#long_comment}

**여러 줄 주석** 블록을 사용하면 여러 줄의 주석을 한번에 입력할 수 있습니다.  
...
**링크** 블록을 사용하면, **주석**을 활용해 열고 싶은 **페이지 링크**를 추가할 수 있습니다.  
...
**종료하기** 블록은 프로그램에서 코드의 실행을 즉시 중단합니다.  
