...
| `TURTLE.OUT.BUZZER` | 부저 주파수 | 1 ~ 167,772.15 Hz | **100 이하는 소리가 나지 않습니다** |
| `TURTLE.OUT.NOTE` | 음정 | 88건반, A0 ~ C8 | `충돌` 사양표에는 A3~A7 |
...
**터틀의 바퀴 속도 단위는 초당 펄스 수(PPS)이며 범위는 -1,024 ~ 1,024 입니다.**  
백분율로 착각해 `50` 을 넣으면 최대 속도의 5% 밖에 되지 않습니다.

**안내 문구 예**  
> 터틀의 속도 단위는 백분율이 아니라 초당 펄스 수(PPS)입니다.  
> 최대 1024 이므로 "속도 50" 은 최대 속도의 5% 에 불과합니다.  
> 보통 속도로 움직이려면 500 정도를 사용합니다.
