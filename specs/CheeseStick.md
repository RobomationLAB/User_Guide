...
포트에 무엇을 연결할 수 있는지 판단할 때 쓰는 전기적 한계입니다.
...
치즈스틱 **본체**에 들어 있는 센서는 아래가 전부입니다.
그 밖의 센서는 확장모듈로 연결합니다.
...
코드로 제어할 수 있는 치즈스틱 본체의 소리 출력입니다.

| ID | 항목 | 범위 | 비고 |
|---|---|---|---|
| `CHEESESTICK.OUT.BUZZER` | 부저 주파수 | 1.0 ~ 6553.5 Hz | **10.0 Hz 미만은 스피커 보호를 위해 소리가 나지 않습니다** |
| `CHEESESTICK.OUT.NOTE` | 음정 | 88건반, A0 ~ C8 | |
